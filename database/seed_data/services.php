...
/**
 * Başlangıç hizmet içerikleri. Admin panelden düzenlenebilir.
 */
return [
    [
        'slug' => 'edc-sanziman',
...
<h2>EDC Şanzımanda Sık Görülen Arızalar</h2>
<ul>
  <li>Araçta sarsıntı, vites geçişlerinde takılma ve tekleme</li>
  <li>Gösterge panelinde şanzıman/EDC uyarı lambasının yanması</li>
  <li>Vitesin boşa atması veya hareket etmemesi</li>
...
HTML,
    ...
    [
        'slug' => 'edc-beyin',
        'title' => 'EDC Beyin (Mekatronik) Onarımı',
        'icon' => 'fa-microchip',
...
<h2>Mekatronik Arıza Belirtileri</h2>
<ul>
  <li>Vites geçişlerinde gecikme veya sertlik</li>
  <li>Şanzıman arıza uyarısı ve acil mod (limp mode)</li>
  <li>Belirli vitese geçememe</li>
  <li>Basınç ve konum sensörü hataları</li>
</ul>
<h2>Onarım Yaklaşımımız</h2>
<p>Mekatronik üniteyi sökerek elektronik kart, valf bloğu ve sensörler üzerinde detaylı arıza tespiti yaparız. Onarım sonrası ünitenin araca uygun şekilde programlanması ve kodlanması tamamlanır. İşlem sonrası yol testiyle doğrulanır ve garantili teslim edilir.</p>
HTML,
    ],
    [
        'slug' => 'kavrama',
        'title' => 'Kavrama (Debriyaj) Tamiri',
...
<h2>Kavrama Arıza Belirtileri</h2>
<ul>
  <li>Kalkışta ve vites geçişlerinde sarsıntı</li>
  <li>Debriyaj kokusu ve kavrama kayması</li>
  <li>Aracın güç kaybetmesi</li>
  <li>Kavrama aktüatör hataları</li>
</ul>
<h2>Hizmet Kapsamımız</h2>
<p>Çift kavrama setinin değişimi, aktüatör onarımı ve kavrama adaptasyon işlemlerini orijinal ekipmanlarla gerçekleştiririz. Değişim sonrası temas noktası öğretme (kalibrasyon) yapılır ve aracınız aynı gün teslim edilir.</p>
HTML,
    ],
    [
        'slug' => 'dw5-otomatik-sanziman',
        'title' => 'DW5 Otomatik Şanzıman Onarımı',
        'icon' => 'fa-wrench',
...
<ul>
  <li>Vites geçişlerinde darbe ve gecikme</li>
  <li>Yağ kaçağı ve yağ ömrünün dolması</li>
  <li>Selektör ve valf bloğu arızaları</li>
  <li>Hidrolik basınç sorunları</li>
</ul>
<h2>Onarım ve Bakım</h2>
<p>Şanzıman yağı ve filtre değişimi, valf bloğu onarımı ve elektronik kontrol işlemlerini eksiksiz uygularız. Tespit edilen arızalar giderildikten sonra yol testi yapılır ve garantili teslim edilir.</p>
HTML,
    ],
    [
        'slug' => 'adblue',
        'title' => 'AdBlue / SCR Sistemi Servisi',
        'icon' => 'fa-tint',
...
<h2>AdBlue Arıza Belirtileri</h2>
<ul>
  <li>AdBlue uyarısı ve geri sayım ikazları</li>
  <li>NOx sensörü ve kalite sensörü hataları</li>
  <li>AdBlue pompası ve enjektör arızaları</li>
  <li>Performans kısıtlaması (limp mode)</li>
</ul>
<h2>Servis Kapsamımız</h2>
<p>SCR sistemini uçtan uca kontrol eder; pompa, enjektör ve sensör arızalarını onararak sistemin sağlıklı çalışmasını sağlarız. İşlem sonrası tüm hata kayıtları silinir ve sistem test edilir.</p>
HTML,
    ],
    [
        'slug' => 'egr',
...
<h2>EGR Arıza Belirtileri</h2>
<ul>
  <li>Motor arıza lambasının yanması</li>
  <li>Rölantide düzensiz çalışma ve stop etme</li>
  <li>Güç kaybı ve yüksek yakıt tüketimi</li>
  <li>Siyah duman ve performans düşüşü</li>
</ul>
<h2>Temizleme ve Onarım</h2>
<p>EGR valfini sökerek profesyonel temizliğini yapar, gerektiğinde onarır veya değiştiririz. İşlem sonrası ilgili adaptasyon ve hata silme işlemleri tamamlanır.</p>
HTML,
    ],
    [
        'slug' => 'partikul-filtre-temizligi',
...
<ul>
  <li>DPF uyarı lambası ve performans kısıtlaması</li>
  <li>Yüksek yakıt tüketimi ve güç kaybı</li>
  <li>Rejenerasyonun tamamlanamaması</li>
  <li>Egzozdan aşırı duman</li>
</ul>
<h2>Profesyonel Temizlik</h2>
<p>Partikül filtreyi özel ekipmanlarla, filtreye zarar vermeden temizleriz. İşlem sonrası rejenerasyon ve adaptasyon yaparak filtrenin verimli çalışmasını sağlarız.</p>
HTML,
    ],
    [
        'slug' => 'eco-performans-yazilimlari',
        'title' => 'ECO Performans Yazılımları',
        'icon' => 'fa-tachometer',
...
<ul>
  ...
  <li>Daha dengeli tork ve sürüş konforu</li>
  <li>Motor parametrelerinin optimize edilmesi</li>
</ul>
<h2>Yaklaşımımız</h2>
<p>Aracınızın motor ve donanım yapısına uygun, güvenli sınırlar içinde yazılım optimizasyonu uygularız. İşlem öncesi orijinal yazılım yedeklenir; talep halinde geri yüklenebilir.</p>
HTML,
    ],
    [
        'slug' => 'airbag-onarimi',
        'title' => 'Airbag Beyin Onarımı',
        'icon' => 'fa-shield',
...
<h2>Hizmet Kapsamımız</h2>
<ul>
  <li>Kaza sonrası airbag beyni arıza silme (crash data)</li>
  <li>Airbag kontrol ünitesi onarımı</li>
  <li>Kodlama ve programlama</li>
</ul>
<p>İşlemler, güvenlik standartlarına uygun şekilde yapılır ve test edilerek teslim edilir.</p>
HTML,
    ],
    [
        'slug' => 'enjeksiyon-beyin-onarimi',
        'title' => 'Enjeksiyon Beyin Onarımı',
        'icon' => 'fa-plug',
        'price' => "3.500 ₺'den başlayan",
...
<h2>Arıza Belirtileri</h2>
<ul>
  <li>Aracın çalışmaması veya zor çalışması</li>
  <li>Tekleme ve performans kaybı</li>
  <li>İletişim (haberleşme) hataları</li>
</ul>
<h2>Onarım Süreci</h2>
<p>ECU üzerindeki elektronik arızaları tespit eder, onarır ve araca uygun şekilde programlarız. İşlem sonrası yol testiyle doğrulayıp garantili teslim ederiz.</p>
HTML,
    ],
];
